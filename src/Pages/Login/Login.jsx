    ...
    >
      <div className="w-full max-w-md">
        ...
        >
              ...
              <div className="relative">
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className={selectedClub ? 'text-gray-900' : 'text-gray-500'}>
                          ...
                          >
                            ...
                            <div>
                              <div className={`text-sm font-medium ${
                                club.name === 'OCA' ? 'text-white' : 'text-gray-900'
                              }`}>
                                {club.name}
                              </div>
                              <div className={`text-xs ${
                                club.name === 'OCA' ? 'text-white text-opacity-80' : 'text-gray-500'
                              }`}>
                                {club.email}
                              </div>
                            </div>
          ...
          >
            <div className="mt-6 text-center text-sm tooltip hover:tooltip-open" data-tip="mail us at: admin@clubsync.com">
              <a href="#" className="text-[#4c44b3] hover:underline w-full text-center">
                Need help?
              </a>
            </div>
          </motion.div>
